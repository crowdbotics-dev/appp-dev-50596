"""
Django settings for appp_dev_50596 project.
...
ROOT_URLCONF = 'appp_dev_50596.urls'
...
WSGI_APPLICATION = 'appp_dev_50596.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "appp_dev_50596 API",
    "DESCRIPTION": "API documentation for appp_dev_50596 App",
    "VERSION": "v1",
}
